#!/usr/bin/env node
/**
 * AgentTrust 0.4.0 Gate E2E driver — run-2 (after init_if_needed fix).
 *
 ...
 *   5) simulate-payment against the freshly-registered agent
 *
...
(async () => {
  ...
  const payee = (demoState && (demoState.payeeAgent || demoState.payee_agent ||
                               (demoState.demo && (demoState.demo.payeeAgent || demoState.demo.payee_agent))))
    || 'BTcgiDauqVHoGMiXujytE5wycfncDEmNnXJiUZ4s4oWL';
