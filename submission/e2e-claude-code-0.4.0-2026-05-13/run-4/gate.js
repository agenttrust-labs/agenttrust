 ...
 * (against @agenttrust-sdk/mcp@0.4.2 with refreshed bundled IDL
 *  after the on-chain init_if_needed upgrade on TrustGateAuthority.)
 *
 * Spawns `npx -y @agenttrust-sdk/mcp@0.4.2` in stdio mode with a fresh
...
console.error('[gate] spawning npx -y @agenttrust-sdk/mcp@0.4.2 ...');
...
const child = spawn('npx', ['-y', '@agenttrust-sdk/mcp@0.4.2'], {
